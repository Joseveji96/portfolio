    ...
    >
      ...
      <div className="flex flex-col lg:flex-row justify-between">
        ...
        >
          ...
          <h3 className="text-xl md:text-2xl mb-4">[ Another Experience ]</h3>
          <Accordion>
            <AccordionItem key="winner" aria-label="Anchor" indicator={<Image src={"/more.svg"} width={32} height={32} alt="More" />} startContent={"2023"} title={<h1 className='text-lg md:text-xl lg:text-2xl'>Winner of the Jalisco regional stage, InnovatecNM</h1>}>
            ...
            <AccordionItem key="agile" aria-label="Anchor" indicator={<Image src={"/more.svg"} width={32} height={32} alt="More" />} startContent={"2023"} title={<h1 className='text-lg md:text-xl lg:text-2xl'>I completed the Certification for the Scrum Methodology</h1>}>
            ...
            <AccordionItem key="winnerAgain" aria-label="Anchor" indicator={<Image src={"/more.svg"} width={32} height={32} alt="More" />} startContent={"2024"} title={<h1 className='text-lg md:text-xl lg:text-2xl'>Once again winner of the Jalisco regional stage, InnovatecNM</h1>}>
            ...
            <AccordionItem key="article" aria-label="Anchor" indicator={<Image src={"/more.svg"} width={32} height={32} alt="More" />} startContent={"2024"} title={<h1 className='text-lg md:text-xl lg:text-2xl'>Co-Wrote an article about Machine Vision</h1>}>
            ...
            <AccordionItem key="graduate" aria-label="Anchor" indicator={<Image src={"/more.svg"} width={32} height={32} alt="More" />} startContent={"2024"} title={<h1 className='text-lg md:text-xl lg:text-2xl'>Graduate of ING. Computer Systems (On hold)</h1>}>
        ...
        <motion.div 
          ...
          className="w-full lg:w-2/5 mt-8 lg:mt-0 lg:pl-10 lg:pt-12 hidden md:block"
        >
          <Image src={"/a-person.png"} width={500} height={500} className="w-full h-auto object-cover rounded-lg shadow-lg" alt="I" />
        </motion.div>
      </div>
    </motion.section>
  );
